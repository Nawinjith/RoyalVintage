...
<!-- <nav class="navbar navbar-expand-sm navbar-dark bg-dark">
      <a class="navbar-brand" href="#">සුවසෙත</a>
      ...
      <div class="collapse navbar-collapse" id="navbarsExample03">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item">
            <a class="nav-link" href="#">Chanelling</a>
          </li>
          <li class="nav-item">
...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
  ...
  <div class="collapse navbar-collapse" id="navbarColor01">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
          <?php  echo anchor('welcome/appoinment', 'Test***', ['class'=> 'nav-link'] ); ?>
      </li>
      <li class="nav-item">
          <?php  echo anchor('welcome/guid', 'Guid', ['class'=> 'nav-link'] ); ?>
      </li>
      <li class="nav-item">
